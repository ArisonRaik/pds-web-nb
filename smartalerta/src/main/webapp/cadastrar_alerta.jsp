                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><strong class="text-success">Alerta cadastrado com sucesso.</strong></p>
                            <p><strong class="text-primary">Agora você pode enviá-lo para alguém.</strong></p>
                        </div>
            ...
            <div id="invalido_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-center">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><strong class="text-danger">Cadastro de alerta malsucedido.</strong></p>
                            <p><strong class="text-warning">Motivo</strong> <b>Título</b> do alerta já está cadastrado.</p>
                        </div>
                        <div class="modal-footer">
