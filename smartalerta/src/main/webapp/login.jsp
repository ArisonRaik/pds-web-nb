<%-- 
    Document   : login
    Created on : 24/11/2017, 11:19:35
    Author     : wagner
--%>
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Não foi possível realizar <strong class="text-primary">Login</strong>.</p>
                        <p><strong class="text-danger">Motivo:</strong> <b>Usuário</b> ou <b>Senha</b> incorreto.</p>
                    </div>
